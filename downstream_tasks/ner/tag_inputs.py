...
if __name__ == '__main__':
    ...
    nlp = stanza.Pipeline('es', processors='tokenize,ner', tokenize_pretokenized=True, download_method=DownloadMethod.REUSE_RESOURCES)
    ...
    with(open(output_dir + '{lang}.tagged'.format(lang=lang), 'w')) as outf:
        for i, sentence in enumerate(tagged_docs.sentences):
            ...
            tokens = [word.text for word in sentence.tokens]
            tags = [word.ner for word in sentence.tokens]
