...
experiment_name=ner_finetuning_newbl group_name=bert_base run_name=${train_lang}_${target_lang}_${train_source}_${model} check_git_status=True use_wandb=True dev=False \
